    ...
    render(){
        ...
        return (
            ...
            <span className="generalBal">
                ...
                RAM
                    <div id="full" style={{background: `linear-gradient(90deg, rgb(255, 208, 0) ${(this.props.resources.ram_usage/this.props.resources.ram_quota)*100}%, rgba(255, 208, 0, 0.384) ${(this.props.resources.cpu_limit.used/this.props.resources.cpu_limit.max)*100}%)`}}>
                    </div>
                ...
                NET
                    <div id="full" style={{backgroundImage: `linear-gradient(90deg, #2191A0 ${(this.props.resources.cpu_limit.used/this.props.resources.cpu_limit.max)*100}%, rgba(33, 145, 160, 0.349) ${(this.props.resources.cpu_limit.used/this.props.resources.cpu_limit.max)*100}%`}}>
